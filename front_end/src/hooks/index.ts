...
const contractAddress = "0x3a9aad56f7940d52f74a5908e502d40901d718cb";
...
const ABI = new Interface([
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_color", type: "uint256" },
      { internalType: "uint256", name: "_windowTint", type: "uint256" },
    ],
    name: "createFloor",
    outputs: [],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "windowsTint", type: "uint256" },
    ],
